...
import { Home, Maximize, BedDouble, Bath, MapPin, ShieldCheck, CheckCircle2 } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <span className="text-brand-cyan font-bold uppercase tracking-widest text-sm block">Welcome to Villa Tiga</span>
            ...
            <div className="space-y-6 text-slate-600 leading-relaxed">
              <p>
                Located in one of Bali's most desirable neighborhoods, this beautifully designed 
                4-bedroom villa in Canggu blends luxury, lifestyle, and investment appeal. 
                Whether you're searching for a home to share unforgettable family moments or a profitable 
                addition to your property portfolio, this villa ticks every box.
              </p>
              <p>
                Built to **European Standards**, the villa boasts luxurious finishes, ample storage, 
                and stunning views of Uluwatu. With 4 ensuite bedrooms and a 'Foodie's' kitchen, 
                it's a perfect family home or high-yield rental investment in a rapidly developing area.
              </p>
            </div>
            ...
            <div className="pt-6">
              <div className="bg-brand-navy text-white p-8 rounded-2xl shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                  <p className="text-white/60 text-xs uppercase tracking-widest mb-1">Indicative Price</p>
                  <p className="text-3xl font-bold text-brand-cyan">IDR 24,500,000,000</p>
                </div>
                <div className="h-px md:h-12 w-full md:w-px bg-white/20"></div>
                <div>
                  <p className="text-white/60 text-xs uppercase tracking-widest mb-1">Tenure</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            {specs.map((spec, index) => (
              ...
              >
                <spec.icon className="w-8 h-8 text-brand-cyan" strokeWidth={1.5} />
                <div className="space-y-1">
                  <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">{spec.label}</p>
                  <p className="text-lg font-bold text-brand-navy">{spec.value}</p>
                </div>
              </div>
            ))}
